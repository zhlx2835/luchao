...
{
	var unit_id     = "2588191";
	var client_ip   = "182.131.17.166";
	var server_time = "1347162172";
	var verify_code = "e1a469ec";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2588191/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
