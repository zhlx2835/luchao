...
{
	var unit_id     = "2597508";
	var client_ip   = "122.228.242.164";
	var server_time = "1347171055";
	var verify_code = "f03ad7fe";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	document.write( "<a href='#' onClick=\""+open_win+"\">&#32473;&#25105;&#30041;&#35328;</a>" );
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2597508/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
